 ...
 */
function rbeta(n, alpha, beta, loc) {
 ...
 * @returns {Array} Random variates array
 */
function rlnorm(n, meanlog, sdlog) {
    n = this._v(n, "n");
 ...
 *
 */
function visualize(data, domID, options) {
    var defaultOptions = {
 ...
 */
function rfml (n, loc, p, cap, trace) {
    n = this._v(n, "n");
...
export { prng, rbeta, rbinom, rcauchy, rchisq, dexp, rexp, rf, rgamma, rint, rlaplace, rlnorm, rnbinom, dnorm, rnorm, dpois, rpois, dunif, runif, rword, sample, visualize, _getCumulativeProbs, _sampleOneIndex, _factorial, _v, rfml, ruf };
